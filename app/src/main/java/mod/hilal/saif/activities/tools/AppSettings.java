...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupPreferences(ViewGroup content) {
        ...
        generalCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_settings_applications, "AI Provider & MCP", "Chat with AI models and enable the full-access MCP server for agents", new ActivityLauncher(new Intent(getApplicationContext(), mod.varda.ai.AiChatActivity.class))), true);
